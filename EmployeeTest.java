...
Employee gracey = new Employee("good", "great", 55.21);
Employee gracei = new Employee("better","best", 45.10);


	gracey.setFirstName("Grace");
	gracey.setLastName("Ajadi");
	gracey.setMonthlySalary(250.00);	
	gracey.getFirstName();
	gracey.getLastName();
	gracey.getMonthlySalary();
	gracey.getYearlySalary();
	...
	gracei.getFirstName();
	gracei.getLastName();
	gracei.getMonthlySalary(); 
	gracei.getYearlySalary(); 
